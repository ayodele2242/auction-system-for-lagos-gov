...
$(document).ready(function() {
	courierTable = $("#courierTable").DataTable({
		"ajax": "courier/retrieve.php",
		"scrollY": 370,
        "scrollX": true,
		"pageLength": 150,
		"order": []
 ...
 // Insert class
 $('#insertCourier').submit(function(event){
	event.preventDefault();
	//var data = $("#register-form").serialize();
	$.ajax({
	  url: "courier/insert.php",
	  method: "post",
	  data: $('form').serialize(),
	  //dataType: "text",
	  beforeSend: function()
