...
$(document).ready(function() {
	hiringTable = $("#hiringTable").DataTable({
		"ajax": "hiring/retrieve.php",
		"scrollY": 370,
        "scrollX": true,
		"pageLength": 150,
		"order": []
 ...
 // Insert class
 $('#insertHire').submit(function(event){
	event.preventDefault();
	//var data = $("#register-form").serialize();
	$.ajax({
	  url: "hiring/insert.php",
	  method: "post",
	  data: $('form').serialize(),
	  //dataType: "text",
	  beforeSend: function()
	  ...
	  success: function(data){
		...
		//$('#insertClass')[0].reset();
		//hiringTable.ajax.reload(null, false);
		if(data=="added")
		{
 ...
 // Update class
 $('#updateHire').submit(function(event){
	event.preventDefault();
	//var data = $("#register-form").serialize();
	$.ajax({
	  url: "hiring/update.php",
	  method: "post",
	  data: $('form').serialize(),
	  //dataType: "text",
	  beforeSend: function()
