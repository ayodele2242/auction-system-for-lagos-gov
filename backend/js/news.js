...
$(document).ready(function() {
	manageDeptTable = $("#manageDeptTable").DataTable({
		"ajax": "inews/retrieve.php",
		"scrollY": 370,
        "scrollX": true,
		"pageLength": 150,
		"order": []
	...
	$("#addDeptModalBtn").on('click', function() {
		// reset the form 
		...
		// submit form
		$("#createDeptForm").unbind('submit').bind('submit', function() {
...
function editMember(id = null) {
	if(id) {
		...
		$.ajax({
			url: 'inews/getSelectedMember.php',
			type: 'post',
			data: {member_id : id},
			dataType: 'json',
			success:function(response) {
