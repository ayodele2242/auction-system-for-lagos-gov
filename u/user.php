...
No auction at the moment. Please check back.
       ...
       <?php 		
				while( $row = mysqli_fetch_assoc($result)){	
						...
						<div class="d-inline bg-white" id="auction<?php echo $row['auctionId'] ?>" style="margin:5px; margin-bottom:15px; padding:7px;">
            ...
            $("#auction" + <?php echo json_encode($row['auctionId']) ?>).remove();
                                    ...
                                    <div class="caption">
                                        <h5 class="text-info"style="font-weight:bolder;" >
                                            <a href="auction_view?id=<?php echo $row['auctionId'] ?>">
